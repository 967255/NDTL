...
from ode import *
from utils_verify import max_lyapunov_exponent, compute_power_spectrum, calc_r0
...
%%%%%%%%%%%%%%%%%%%
'''
# ode_test_list = [ode_shifted_list[0], ode_shifted_list[4]]
ode_test_list = ode_shifted_list
...
%%%%%%%%%%%%%%%%%%%
'''
# cae.load_state_dict(torch.load('./checkpoints/transfer_lorenz_rossler_cae.pt'))
cae.load_state_dict(torch.load('./checkpoints/transfer_0216.pt'))
cae.eval()
...
def fusion_verify(sys_a, sys_b, w_styl=0.01, cont_weight_list_1=None, both_styl=True,\
    ...
    '''
    # ['lorenz_shifted', 'chen_shifted', 'lv_shifted', 'seirs', 'rossler_shifted', 'prs']
    target_ode_list = [ode_shifted_list[sys_a], ode_shifted_list[sys_b]]
...
if __name__ == "__main__":
    # ['lorenz_shifted', 'chen_shifted', 'lv_shifted', 'seirs', 'rossler_shifted', 'prs']
    '''
        fusion_verify(sys_a=0, sys_b=1, w_styl=0.01,\
                    cont_weight_list_1 = [0.001, 0.01, 0.02, 0.05], cont_weight_list_2 = [0.0],\
                        grid_limits = [[-25, 25], [-25, 25], [0, 50]], both_styl=False, check_r0 = False, compute_l_exp=True, compute_power_spec=True, exp_plot_save=True)
        fusion_verify(sys_a=0, sys_b=2, w_styl=0.01,\
                    cont_weight_list_1 = [0.001, 0.01, 0.02, 0.05], cont_weight_list_2 = [0.0],\
                        grid_limits = [[-25, 25], [-25, 25], [0, 50]], both_styl=False, check_r0 = False, compute_l_exp=True, compute_power_spec=True, exp_plot_save=True)
        fusion_verify(sys_a=1, sys_b=2, w_styl=0.01,\
                    cont_weight_list_1 = [0.001, 0.01, 0.02, 0.05], cont_weight_list_2 = [0.0],\
                        grid_limits = [[-25, 25], [-25, 25], [0, 50]], both_styl=False, check_r0 = False, compute_l_exp=True, compute_power_spec=True, exp_plot_save=True)
    '''
    '''
    fusion_verify(sys_a=0, sys_b=5, w_styl=0.01,\
                  cont_weight_list_1 = [0.01, 0.05, 0.1, 0.5, 0.9, 1.0], cont_weight_list_2 = [0.0],\
                      grid_limits = [[-25, 25], [-25, 25], [0, 50]], both_styl=False, check_r0 = False, compute_l_exp=True, compute_power_spec=True, exp_plot_save=True)
    fusion_verify(sys_a=1, sys_b=5, w_styl=0.01,\
                  cont_weight_list_1 = [0.01, 0.05, 0.1, 0.5, 0.9, 1.0], cont_weight_list_2 = [0.0],\
                      grid_limits = [[-25, 25], [-25, 25], [0, 50]], both_styl=False, check_r0 = False, compute_l_exp=True, compute_power_spec=True, exp_plot_save=True)
    fusion_verify(sys_a=2, sys_b=5, w_styl=0.01,\
                  cont_weight_list_1 = [0.01, 0.05, 0.1, 0.5, 0.9, 1.0], cont_weight_list_2 = [0.0],\
                      grid_limits = [[-25, 25], [-25, 25], [0, 50]], both_styl=False, check_r0 = False, compute_l_exp=True, compute_power_spec=True, exp_plot_save=True)
    '''
    fusion_verify(sys_a=3, sys_b=2, w_styl=0.01,\
                  cont_weight_list_1 = [1.0, 5.0, 10.0, 50.0, 100.0], cont_weight_list_2 = [0.0],\
                      grid_limits = [[0, 1], [0, 1], [0, 1]], both_styl=False, check_r0 = False, compute_l_exp=True, compute_power_spec=False, exp_plot_save=False)